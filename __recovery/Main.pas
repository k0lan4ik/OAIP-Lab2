...
uses
  ...
  Vcl.ExtCtrls, Vcl.MPlayer, film,drawSomeThing, System.Types;
...
begin
  ...
  begin
    Snowflakes[i].Y := Snowflakes[i].Y + Snowflakes[i].Speed * 0.1;
    ...
    begin
      ...
      Snowflakes[i].Speed := Random(5) / 5000 + 0.0004; // 0.004/0.012
    end;
  end;
